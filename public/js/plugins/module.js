...
function g(t, e, s) {
    var i;
    return "#text" === t.nodeName ? i = s.document.createTextNode(t.data) : "#comment" === t.nodeName ? i = s.document.createComment(t.data) : (e ? (i = s.document.createElementNS("http://www.w3.org/2000/svg", t.nodeName),
    "foreignObject" === t.nodeName && (e = !1)) : "svg" === t.nodeName.toLowerCase() ? (i = s.document.createElementNS("http://www.w3.org/2000/svg", "svg"),
    ...
    s.valueDiffing && (t.value && m(i, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (i.value = t.value),
    t.checked && m(i, "HTMLInputElement") && (i.checked = t.checked),
    t.selected && m(i, "HTMLOptionElement") && (i.selected = t.selected))),
    i
}
var b = function(t, e) {
...
function v(t, e, s) {
    ...
    case s._const.modifyAttribute:
        ...
        m(i, "HTMLInputElement") && "value" === e[s._const.name] && (i.value = e[s._const.newValue]);
        break;
    ...
    case s._const.modifyTextElement:
        ...
        m(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.newValue]);
        break;
    ...
    case s._const.addTextElement:
        ...
        m(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.value]);
        break;
    default:
...
var y = function(t) {
  ...
  , x = function(t) {
    ...
    return Object.prototype.hasOwnProperty.call(t, "attributes") && (e.attributes = u({}, t.attributes)),
  ...
  , $ = function(t, e) {
    for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = V(s.length, !1), a = V(i.length, !1), o = [], r = function() {
        ...
        var t = function(t, e, s, i) {
            ...
            for (var h = 0; h < o; h++)
                for (var u = t[h], f = 0; f < r; f++) {
                    var m = e[f];
                    s[h] || i[f] || !E(u, m, d, c) ? l[h + 1][f + 1] = 0 : (l[h + 1][f + 1] = l[h][f] ? l[h][f] + 1 : 1,
        ...
        t ? (o.push(t),
        p([], new Array(t.length), !0).map(r).forEach((function(e) {
    ...
    return e.forEach((function(e) {
        !function(t, e, s) {
            ...
            case s._const.addElement:
                ...
                n = null === (i = k(t, d)) || void 0 === i ? void 0 : i.node,
            ...
            case s._const.addTextElement:
                ...
                (n = k(t, d).node).childNodes || (n.childNodes = []),
...
function T(t, e) {
    ...
    if (m(t, "Text", "Comment"))
        ...
        e.valueDiffing && (m(t, "HTMLTextAreaElement") && (s.value = t.value),
        m(t, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : m(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value),
...
var R = {
  ...
  , H = function(t, e) {
    var s = {
      ...
      , i = !1
      , n = t.match(/<\/?([^\s]+?)[/\s>]/);
    if (n && (s.nodeName = e || "svg" === n[1] ? n[1] : n[1].toUpperCase(),
    ...
    for (var o = new RegExp(L), r = null, l = !1; !l; )
        if (null === (r = o.exec(t)))
            ...
            if (r[1]) {
                ...
                r[2] && (s.attributes[r[2]] = r[3].trim().substring(1, r[3].length - 1));
    return {
        type: "tag",
        node: s,
        voidElement: i
  ...
  , I = function(t, e) {
    ...
    return t.replace(A, (function(r, l) {
        ...
        if (d) {
            if ("svg" === (s = H(r, e.caseSensitive || o)).node.nodeName && (o = !0),
            n++,
            !s.voidElement && u && "<" !== u) {
            ...
            var g = a[n - 1];
            g && s.node.nodeName && (g.node.childNodes || (g.node.childNodes = []),
            g.node.childNodes.push(s.node)),
            a[n] = s
        }
        if ((!d || s.voidElement) && (n > -1 && (s.voidElement || e.caseSensitive && s.node.nodeName === r.slice(2, -1) || !e.caseSensitive && s.node.nodeName.toUpperCase() === r.slice(2, -1).toUpperCase()) && --n > -1 && ("svg" === s.node.nodeName && (o = !1),
        s = a[n]),
        "<" !== u && u)) {
  ...
  , Y = function() {
    function t(t, e, s) {
        this.options = s,
        this.t1 = "undefined" != typeof Element && m(t, "Element") ? T(t, this.options) : "string" == typeof t ? I(t, this.options) : JSON.parse(JSON.stringify(t)),
        this.t2 = "undefined" != typeof Element && m(e, "Element") ? T(e, this.options) : "string" == typeof e ? I(e, this.options) : JSON.parse(JSON.stringify(e)),
        this.diffcount = 0,
        this.foundAll = !1,
        this.debug && (this.t1Orig = "undefined" != typeof Element && m(t, "Element") ? T(t, this.options) : "string" == typeof t ? I(t, this.options) : JSON.parse(JSON.stringify(t)),
        this.t2Orig = "undefined" != typeof Element && m(e, "Element") ? T(e, this.options) : "string" == typeof e ? I(e, this.options) : JSON.parse(JSON.stringify(e))),
        this.tracker = new C
    }
    ...
    t.prototype.findDiffs = function(t, e) {
        ...
        do {
            ...
            0 === (s = this.findNextDiff(t, e, [])).length && (O(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0,
            N(t),
    ...
    t.prototype.findOuterDiff = function(t, e, s) {
        ...
        if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
            return "#text" === t.nodeName ? [(new f).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)] : [(new f).setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)];
        for (n = t.attributes ? Object.keys(t.attributes).sort() : [],
        a = e.attributes ? Object.keys(e.attributes).sort() : [],
        o = n.length,
        l = 0; l < o; l++)
            i = n[l],
            -1 === (r = a.indexOf(i)) ? d.push((new f).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1),
            t.attributes[i] !== e.attributes[i] && d.push((new f).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
        for (o = a.length,
        l = 0; l < o; l++)
            i = a[l],
            d.push((new f).setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
        return d
    }
    ,
    t.prototype.findInnerDiff = function(t, e, s) {
        ...
        for (var h = 0; h < a; h += 1) {
            var u = i[h]
              , p = n[h];
            o && (u && !p ? "#text" === u.nodeName ? (r.push((new f).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)),
            l -= 1) : (r.push((new f).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(u))),
            l -= 1) : p && !u && ("#text" === p.nodeName ? r.push((new f).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, p.data)) : r.push((new f).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(p))))),
            u && p && (!this.options.maxChildCount || a < this.options.maxChildCount ? r = r.concat(this.findNextDiff(u, p, s.concat(l))) : O(u, p) || (i.length > n.length ? ("#text" === u.nodeName ? r.push((new f).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)) : r.push((new f).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.element, x(u)).setValue(this.options._const.route, s.concat(l))),
            i.splice(h, 1),
            h -= 1,
            l -= 1,
            o -= 1) : i.length < n.length ? (r = r.concat([(new f).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, x(p)).setValue(this.options._const.route, s.concat(l))]),
            i.splice(h, 0, x(p)),
            o -= 1) : r = r.concat([(new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(u)).setValue(this.options._const.newValue, x(p)).setValue(this.options._const.route, s.concat(l))]))),
            l += 1
        }
    ...
    t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
        ...
        }(t, e, s), h = c.gaps1, u = c.gaps2, p = t.childNodes.slice(), m = e.childNodes.slice(), g = Math.min(h.length, u.length), b = [], v = 0, _ = 0; v < g; _ += 1,
        v += 1)
            if (!n || !0 !== h[v] && !0 !== u[v]) {
                if (!0 === h[_])
                    if ("#text" === (l = p[_]).nodeName)
                        if ("#text" === m[v].nodeName) {
                            if (l.data !== m[v].data) {
                                for (var w = _; p.length > w + 1 && "#text" === p[w + 1].nodeName; )
                                    if (w += 1,
                                    m[v].data === p[w].data) {
                                        d = !0;
                                        break
                            ...
                            b.push((new f).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)),
                            h.splice(_, 1),
                            p.splice(_, 1),
                        ...
                        !0 === u[v] ? b.push((new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(l)).setValue(this.options._const.newValue, x(m[v])).setValue(this.options._const.route, i.concat(_))) : (b.push((new f).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, x(l))),
                        h.splice(_, 1),
                        p.splice(_, 1),
                        g = Math.min(h.length, u.length),
                        _ -= 1,
                    ...
                    "#text" === (l = m[v]).nodeName ? (b.push((new f).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)),
                    h.splice(_, 0, !0),
                    p.splice(_, 0, {
                        nodeName: "#text",
                        data: l.data
                    }),
                    g = Math.min(h.length, u.length)) : (b.push((new f).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, x(l))),
                    h.splice(_, 0, !0),
                    p.splice(_, 0, x(l)),
                    g = Math.min(h.length, u.length));
                else if (h[_] !== u[v]) {
                    if (b.length > 0)
                        return b;
                    if (r = s[h[_]],
                    (o = Math.min(r.newValue, p.length - r.length)) !== r.oldValue) {
                        a = !1;
                        for (var y = 0; y < r.length; y += 1)
                            E(p[o + y], p[r.oldValue + y], {}, !1, !0) || (a = !0);
                        if (a)
                            return [(new f).setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)]
                    }
                }
            } else
                ;
    ...
    t.prototype.findValueDiff = function(t, e, s) {
        var i = [];
        return t.selected !== e.selected && i.push((new f).setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
        (t.value || e.value) && t.value !== e.value && "OPTION" !== t.nodeName && i.push((new f).setValue(this.options._const.action, this.options._const.modifyValue).setValue(this.options._const.oldValue, t.value || "").setValue(this.options._const.newValue, e.value || "").setValue(this.options._const.route, s)),
        t.checked !== e.checked && i.push((new f).setValue(this.options._const.action, this.options._const.modifyChecked).setValue(this.options._const.oldValue, t.checked).setValue(this.options._const.newValue, e.checked).setValue(this.options._const.route, s)),
        i
    }
    ,
    t
...
const F = (t, e, s, {classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l}, {noColumnWidths: d, unhideHeader: h}) => ({
    ...
    childNodes: t.map(( (t, u) => {
        ...
        if (p.sortable && o && (!r.length || h) && (p.filter ? f["data-filterable"] = "true" : f["data-sortable"] = "true"),
        p.headerClass && (f.class = c(f.class, p.headerClass)),
        s.sort && s.sort.column === u) {
            const t = "asc" === s.sort.dir ? i.ascending : i.descending;
            f.class = c(f.class, t),
            f["aria-sort"] = "asc" === s.sort.dir ? "ascending" : "descending"
        } else
  ...
  , B = (t, e, s, i, a, o, {classes: r, hiddenHeader: l, header: d, footer: h, format: u, sortable: p, scrollY: f, type: m, rowRender: g, tabIndex: b}, {noColumnWidths: v, unhideHeader: _, renderHeader: w}, y, M) => {
            ...
            childNodes: s.map(( ({row: t, index: e}) => {
                const s = {
                    ...
                    childNodes: t.cells.map(( (t, s) => {
                        ...
                        if (d || h || !a.widths[s] || v || (r.attributes.style = c(r.attributes.style, `width: ${a.widths[s]}%;`)),
                ...
                if (e === o && (s.attributes.class = c(s.attributes.class, r.cursor)),
                g) {
                    const i = g(t, s, e);
                    if (i) {
                        if ("string" != typeof i)
    ...
    if (D.attributes.class = c(D.attributes.class, r.table),
    d || h || w) {
        const t = F(e, i, a, {
            classes: r,
            hiddenHeader: l,
    ...
    return y.forEach((t => D.childNodes.push(t))),
...
var U = {
  ...
  , W = z(U.exports = function() {
    ...
    var O = function() {
        ...
        ,
        b.$set = function(t, e) {
            var s, l = x.p(t), c = "set" + (this.$u ? "UTC" : ""), p = (s = {},
            s[r] = c + "Date",
            s[u] = c + "Date",
            s[d] = c + "Month",
            s[h] = c + "FullYear",
        ...
        b.diff = function(i, u, p) {
            var f, m = this, g = x.p(u), b = N(i), v = (b.utcOffset() - this.utcOffset()) * e, _ = this - b, w = function() {
                return x.m(m, b)
            };
            switch (g) {
            case h:
...
const X = (t, e) => {
  ...
  , Z = (t, e) => {
    if (t?.constructor === Object && Object.prototype.hasOwnProperty.call(t, "data") && !Object.keys(t).find((t => !["text", "order", "data", "attributes"].includes(t))))
        return t;
    const s = {
        data: t
    };
  ...
  , K = (t, e=void 0, s, n, a) => {
    ...
    if (t.headings)
        o.headings = t.headings.map((t => G(t)));
    else if (e?.tHead)
        ...
        e?.tBodies.length && (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t => G(""))));
    ...
    if (t.data) {
        ...
        o.data = t.data.map((t => {
            ...
            n = t) : t.hasOwnProperty("cells") && Object.keys(t).every((t => ["cells", "attributes"].includes(t))) ? (i = t.attributes,
            n = t.cells) : (i = {},
            n = [],
        ...
        e?.tBodies?.length && (o.data = Array.from(e.tBodies[0].rows).map((t => ({
            ...
            cells: Array.from(t.cells).map(( (t, e) => {
                const i = t.dataset.content ? Z(t.dataset.content, s[e]) : ( (t, e) => {
                    ...
                    return s.attributes = r(t.attributes),
                    s
                }
                )(t, s[e]);
    ...
    if (o.data.length && o.data[0].cells.length !== o.headings.length)
...
class et {
    ...
    add(t) {
        ...
        if (this.dt.data.headings = this.dt.data.headings.concat([G(t.heading)]),
...
const st = {
  ...
  , nt = (t, e, s, i, n) => {
    let a = [];
    if (n.firstLast && a.push(it(1, n.firstText, n)),
    n.nextPrev) {
        const e = t ? 1 : s - 1;
...
class at {
    ...
    init() {
        if (this.initialized || d(this.dom, this.options.classes.table))
            return !1;
        this._virtualDOM = T(this.dom, this.options.diffDomOptions || {}),
        ...
        void 0 !== this.options.caption && this._tableCaptions.push({
            nodeName: "CAPTION",
            childNodes: [{
                nodeName: "#text",
        ...
        this.data = K(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format),
        this._render(),
        setTimeout(( () => {
    ...
    _renderSeparateHeader() {
        ...
        if (e.attributes.class = c(e.attributes.class, this.options.classes.table),
        ...
        if (this.options.destroyable) {
            if (this.wrapperDOM) {
                ...
                if (t) {
                    ...
                    t.replaceChild(i, this.wrapperDOM),
                    this.dom = i
                } else
                    this.options.classes.table?.split(" ").forEach((t => this.wrapperDOM.classList.remove(t)))
            }
    ...
    search(t, e=void 0, s="search") {
        if (this.emit("datatable.search:before", t, this._searchData),
        !t.length)
    ...
    multiSearch(t, e="search") {
        ...
        if (this.emit("datatable.multisearch:before", s, this._searchData),
        e.length && (s = s.concat(this._searchQueries.filter((t => t.source !== e)))),
        ...
        this.data.data.forEach(( (t, e) => {
            const a = t.cells.map(( (t, e) => {
                ...
                if (s.searchMethod || this.options.searchMethod)
                    return t;
                let i = n(t).trim();
                if (i.length) {
                    const t = s.sensitivity || this.options.sensitivity;
                    ["base", "accent"].includes(t) && (i = i.toLowerCase()),
                    ["base", "case"].includes(t) && (i = i.normalize("NFD").replace(/\p{Diacritic}/gu, ""));
    ...
    page(t, e=!1) {
        return this.emit("datatable.page:before", t),
        t !== this._currentPage && (isNaN(t) || (this._currentPage = t),
        ...
        if (Array.isArray(e)) {
            ...
            e.forEach(( (e, i) => {
                ...
                Object.entries(e).forEach(( ([e,s]) => {
                    const a = t.indexOf(e);
                    a > -1 ? n[a] = Z(s, this.columns.settings[a]) : this.hasHeadings || this.hasRows || 0 !== i || (n[t.length] = Z(s, this.columns.settings[t.length]),
                    t.push(e),
            ...
            t(e) && (!e.headings || this.hasHeadings || this.hasRows ? e.data && Array.isArray(e.data) && (s = e.data.map((t => {
                let e, s;
    ...
    refresh() {
        if (this.emit("datatable.refresh:before"),
        this.options.searchable) {
            const t = l(this.options.classes.input);
            Array.from(this.wrapperDOM.querySelectorAll(t)).forEach((t => t.value = "")),
            this._searchQueries = []
        }
        this._currentPage = 1,
        this.onFirstPage = !0,
    ...
    setMessage(t) {
        ...
        this.options.classes.empty?.split(" ").forEach((t => this.wrapperDOM.classList.add(t))),
        ...
        if (this._tableFooters.forEach((t => s.childNodes.push(t))),
  ...
  , lt = function(e, s={}) {
    ...
    if (i.selection)
        if (Array.isArray(i.selection)) {
            ...
            r = e.pages[i.selection - 1].map((t => t.row));
    else
        r = e.data.data;
    let l = [];
    if (l[0] = o,
    l = l.concat(r.map((t => t.cells.filter(( (t, e) => a(e))).map((t => n(t)))))),
    l.length) {
        let t = "";
        if (l.forEach((e => {
            e.forEach((e => {
  ...
  , dt = function(e, s={}) {
    ...
    if (i.selection)
        if (Array.isArray(i.selection)) {
            ...
            o = e.pages[i.selection - 1].map((t => t.row));
    else
        o = e.data.data;
...
class pt {
    ...
    init() {
        this.initialized || (this.options.classes.editable?.split(" ").forEach((t => this.dt.wrapperDOM.classList.add(t))),
    ...
    bindEvents() {
        ...
        this.events.reset = h(( () => this.events.updateMenu()), 50),
    ...
    saveCell(t) {
        ...
        this.dt.data.data[this.data.rowIndex].cells[this.data.columnIndex] = n,
        this.closeModal();
    ...
    saveRow(t, e) {
        ...
        if (t) {
            let s = 0;
            i.cells = e.map(( (e, i) => {
                if (this.options.excludeColumns.includes(i) || this.dt.columns.settings[i].hidden)
                    return e;
...
export {at as DataTable, bt as addColumnFilter, ot as convertCSV, rt as convertJSON, s as createElement, lt as exportCSV, dt as exportJSON, ct as exportSQL, ht as exportTXT, e as isJson, t as isObject, ft as makeEditable};
