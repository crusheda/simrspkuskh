        ...
        <div class="card table-card border shadow-none">
            <div class="card-header d-flex align-items-center justify-content-between p-3">
                ...
                <div class="btn-group">
                    ...
                    @endrole
                    <button class="btn btn-subtle-primary btn-sm" onclick="loadCpptKfr()" id="btn-refresh-riwayat-cppt" data-bs-toggle="tooltip" title="Refresh Riwayat CPPT"><i class="fas fa-sync"></i></button>
                    <button class="btn btn-subtle-warning btn-sm" onclick="loadRiwayatKfr()" id="btn-refresh-riwayat-form-kfr" data-bs-toggle="tooltip" title="Refresh Riwayat Formulir KFR"><i class="fas fa-sync"></i></button>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="alert alert-primary mb-0" role="alert">
                            <i class="ph-duotone ph-arrow-bend-down-right me-1"></i> Pastikan untuk mengisi formulir dengan lengkap dan akurat. Formulir ini akan digunakan sebagai acuan dalam perencanaan dan pelaksanaan program rehabilitasi medik pasien. <br>
                            <i class="ph-duotone ph-arrow-bend-down-right me-1"></i> Isian dengan tanda (<a class="text-danger">*</a>) wajib diisi. Jangan lupa untuk menyimpan formulir setelah selesai mengisi. <br>
                            <i class="ph-duotone ph-arrow-bend-down-right me-1"></i> Apabila ingin menggunakan formulir KFR dari kunjungan sebelumnya, silakan klik tombol <span class="badge bg-info badge-sm" disabled><i class="ph-duotone ph-file-search me-1"></i> Gunakan Form Lama</span> di atas, lalu pilih formulir yang ingin digunakan. <br>
                            <i class="ph-duotone ph-arrow-bend-down-right me-1"></i> Setelah memilih formulir lama, pastikan untuk meninjau kembali isian formulir tersebut dan melakukan update jika diperlukan, agar sesuai dengan kondisi pasien saat ini. <br>
                            <i class="ph-duotone ph-arrow-bend-down-right me-1"></i> Pengisian Formulir KFR <span class="badge text-bg-danger badge-sm p-1">UTAMA</span> Periode pertama/baru dapat langsung <strong class="text-warning"><u>Copy CPPT</u></strong> atau melakukan pengisian baru di formulir di bawah ini, lalu Klik tombol <span class="badge bg-primary badge-sm" disabled><i class="fas fa-save me-1"></i> Simpan Formulir Baru</span>
                        </div>
                    </div>
                    <div class="col-md-6">
