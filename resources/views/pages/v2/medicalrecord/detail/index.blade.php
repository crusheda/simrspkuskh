    ...
    <div class="app-page-head d-flex align-items-center justify-content-between">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="{{ route('v2.emr') }}"></a>Medical Record</li>
                <li class="breadcrumb-item active" aria-current="page"><b data-bs-toggle="tooltip" data-bs-placement="bottom" title="Nomor Kunjungan Pasien">KUNJ#{{ $list['KUNJUNGAN'] }}</b></li>
            </ol>
        </nav>
    </div>
    <!-- [ breadcrumb ] end -->
