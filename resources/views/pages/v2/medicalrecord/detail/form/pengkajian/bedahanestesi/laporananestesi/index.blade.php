<div class="d-flex justify-content-between align-items-center">
    <button
        ...
        data-bs-target="#lapAnes_anestesi"
        aria-expanded="true"
        aria-controls="lapAnes_anestesi"
    >
        <i class="ri-stethoscope-line me-1"></i>
        Laporan Anestesi
    </button>
    <h6 id="pilihPengkajian" class="mb-0 pilih-form-title">Pilih Form</h6>
    <button
        type="button"
        class="btn btn-success waves-effect waves-light collapsed"
        id="btnPerawat"
        data-bs-toggle="collapse"
        data-bs-target="#lapAnes_pasca_anestesi"
        aria-expanded="false"
        aria-controls="lapAnes_pasca_anestesi"
    >
        <i class="ri-stethoscope-line me-1"></i>
        Instruksi Pasca Anestesi
    </button>
</div>
<div class="accordion" id="lapAnesAccordion">
    <div
        class="multi-collapse collapse"
        data-bs-parent="#lapAnesAccordion"
        id="lapAnes_anestesi"
        data-kunjungan="{{ $list['kunjungan'] }}"
        data-form-key="lap_anestesi"
        data-url="{{ route('v2.emr.form.sub.load', ['kunjungan' => $list['kunjungan'], 'formKey' => 'lap_anestesi']) }}"
    >
    ...
    <div
        class="multi-collapse collapse"
        data-bs-parent="#lapAnesAccordion"
        id="lapAnes_pasca_anestesi"
        data-kunjungan="{{ $list['kunjungan'] }}"
        data-form-key="lap_pasca_anestesi"
        data-url="{{ route('v2.emr.form.sub.load', ['kunjungan' => $list['kunjungan'], 'formKey' => 'lap_pasca_anestesi']) }}"
    >
        <div class="form-content mt-3"></div>
    </div>
</div>
    ...
    (function ($) {
        ...
        */
        ...
        function updateRanapDewasaButton() {
            $('#btnDokter').prop(
                'disabled',
                $('#lapAnes_anestesi').hasClass('show')
            );
            $('#btnPerawat').prop(
                'disabled',
                $('#lapAnes_pasca_anestesi').hasClass('show')
            );
        }
            ...
            */
            ...
            .done(function (html) {
                ...
                */
                ...
                $('#lapAnesAccordion')
                    .find('#lapAnes_anestesi, #lapAnes_pasca_anestesi')
                    .not($section)
                    .find('.form-content')
                    .empty();
            ...
            */
            ...
            $('#lapAnesAccordion')
                .off(
                    ...
                    '#lapAnes_anestesi, #lapAnes_pasca_anestesi'
                )
                .on(
                    'shown.bs.collapse.ridRanap',
                    '#lapAnes_anestesi, #lapAnes_pasca_anestesi',
            ...
            */
            ...
            $(document)
                .off(
                    ...
                    '#lapAnesAccordion .form-content .single-checkbox'
                )
                .on(
                    'change.ridSingleCheckbox',
                    '#lapAnesAccordion .form-content .single-checkbox',
            ...
            */
            ...
            $(document)
                .off(
                    ...
                    '#lapAnesAccordion .form-content .single-checkbox-bos'
                )
                .on(
                    'change.ridSingleCheckboxBos',
                    '#lapAnesAccordion .form-content .single-checkbox-bos',
