<div class="form-wrapper" id="form_rajal_psikiatri_dokter">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <div class="col-md-12 mb-3">
                            @include('pages.v2.medicalrecord.detail.form.pengkajian.components.rawat_jalan.pemeriksaan_fisik_rajal',['section' => '#rjj_dokter'])
                        </div>
                    <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                @include('pages.v2.medicalrecord.detail.form.pengkajian.components.diagnosis_icd',['section' => '#rjj_dokter'])
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-2">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12 mb-3">
                            @include('pages.v2.medicalrecord.detail.form.pengkajian.components.rawat_jalan.tolok_ukur_terapi',['section' => '#rjj_dokter'])
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12 mb-3">
                @include('pages.v2.medicalrecord.detail.form.pengkajian.components.rawat_jalan.materi_edukasi',['section' => '#rjj_dokter'])
            </div>
            <div class="col-md-12 mb-3">
