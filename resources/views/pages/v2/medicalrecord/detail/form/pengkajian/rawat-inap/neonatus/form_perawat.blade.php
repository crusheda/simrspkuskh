<div class="form-wrapper position-relative" id="form_ranap_neonatus_perawat" data-rin-form>
    <h1 class="display-6 mb-1 fs-27 fw-bold"><center>PENGKAJIAN AWAL KEPERAWATAN <b class="text-danger">RAWAT INAP</b> <b class="text-warning">NEONATUS</b></center></h1>
    ...
    <div class="form-content">
        ...
        <div class="col-md-12 mb-3">
            @include('pages.v2.medicalrecord.detail.form.pengkajian.components.rawat_inap.masalah_keperawatan',
                [
                    'section' => '#rin_perawat',
                    'form' => 'neonatus' // pilihan = 'dewasa' / 'anak' / 'neonatus' / 'obsgyn'
                ]
            )
        </div>
        <div class="col-md-12">
