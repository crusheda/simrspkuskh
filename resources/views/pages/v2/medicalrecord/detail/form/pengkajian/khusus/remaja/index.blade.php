<div class="form-wrapper" id="form_khusus_remaja">
    <h1 class="display-6 mb-1 mt-2 fs-23 fw-medium"><center>PENGKAJIAN <b class="text-primary">PASIEN REMAJA</b></center></h1>
...
(function () {
    ...
    function getData() {
        ...
        $.ajax({
            url: `/api/v2/emr/pengkajian/khu/remaja/${kunjungan}`,
            type: 'GET',
            dataType: 'json',
    ...
    function simpanData() {
        ...
        $.ajax({
            url: `/api/v2/emr/pengkajian/khu/remaja/${kunjungan}/simpan`,
            type: 'POST',
            data: data,
