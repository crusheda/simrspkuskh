...
<div
    class="pemeriksaan-anatomi-component"
    data-pemeriksaan-anatomi
            ...
            <div class="col">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <label class="form-label fw-bold mb-0 flex-shrink-0">
                            Ada Kelainan Mata?
                        </label>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="form-check flex-shrink-0 m-0">
                            ...
                            <input
                                class="form-check-input single-checkbox buka-lainnya"
                                type="checkbox"
                                data-target="#pf_pkl_lain"
                                name="pf_pkl"
                                value="1"
                        ...
                        <div class="d-flex align-items-center gap-3 ms-auto">
                            ...
                            <div class="form-check m-0">
                                ...
                                <input
                                    class="form-check-input single-checkbox"
                                    type="checkbox"
                                    data-target="#pf_nyeri_tekan_lain"
                                    name="pf_nyeri_tekan"
                                    value="0"
                                >
                            ...
                            <div class="d-flex align-items-center gap-2 mb-0 flex-grow-1">
                                ...
                                <input
                                    type="text"
                                    class="form-control form-control-sm flex-grow-1"
                                    name="pf_nyeri_tekan_lain"
                                    id="pf_nyeri_tekan_lain"
                                    placeholder="Lokasi ?"
                                    disabled
                                >
