                ...
                <div class="form-group">
                    ...
                    <div class="row align-items-start">
                        <div class="col-md-6 mb-2 d-flex flex-column">
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-md-9">
                                    <input class="form-check-input check-primary" type="checkbox" name="diag_utama" value="1">
                                    <label class="form-check-label">
                                        Diagnosis Utama
                                    </label>
                                </div>
                                <div class="col-md-3">
                                    <div class="btn-group">
                                        <button class="btn btn-success" id="btnTambahDiagnosis" onclick="tambahDiagnosis()">
                                            <i class="ri-add-box-line"></i>
                                        </button>
                                        <button class="btn btn-subtle-warning" id="btnRefreshDiagnosis" onclick="getDiagnosis()">
                                            <i class="ri-refresh-line"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <textarea class="form-control" name="diag_detail" placeholder="Masukkan Diagnosis" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
