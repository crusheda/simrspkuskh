...
<div class="accordion mt-3" id="rinAccordion">
    <div class="multi-collapse collapse show" data-bs-parent="#rinAccordion" id="rin_dokter" data-kunjungan="{{ $list['kunjungan'] }}">
        @include('pages.v2.medicalrecord.detail.form.pengkajian.rawat-inap.neonatus.form_dokter')
    </div>
    <div class="multi-collapse collapse" data-bs-parent="#rinAccordion" id="rin_perawat" data-kunjungan="{{ $list['kunjungan'] }}">
        @include('pages.v2.medicalrecord.detail.form.pengkajian.rawat-inap.neonatus.form_perawat')
    </div>
</div>
...
<script>
    ...
    function updateButton() {
        $('#btnDokter').prop('disabled', $('#rin_dokter').hasClass('show'));
        $('#btnPerawat').prop('disabled', $('#rin_perawat').hasClass('show'));
    }
</script>
