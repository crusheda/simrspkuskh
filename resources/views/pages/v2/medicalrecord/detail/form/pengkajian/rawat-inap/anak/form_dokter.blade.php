<div class="form-wrapper" id="form_ranap_anak_dokter">
    <h1 class="display-6 mb-1 fs-27 fw-bold"><center>PENGKAJIAN AWAL MEDIS <b class="text-danger">RAWAT INAP</b> <b class="text-warning">ANAK</b></center></h1>
