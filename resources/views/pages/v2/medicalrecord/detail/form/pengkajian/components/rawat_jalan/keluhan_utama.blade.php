...
(function () {
    ...
    function getPemeriksaanFisik() {
        ...
        if (!$form.length) {
            console.warn('Form Keluhan Utama tidak ditemukan.');
            return;
        }
        ...
        $.ajax({
            url: `/api/v2/emr/pengkajian/rajal/keluhan_utama/${kunjungan}`,
            type: 'GET',
            dataType: 'json',
            ...
            success: function (res) {
                ...
                if (FormHelper.hasValue(tlt.KELUHAN_UTAMA)) {
                    FormHelper.setValue(
                        $section,
                        'anm_ku',
                        tlt.KELUHAN_UTAMA
            ...
            error: function (xhr, status, error) {
                ...
                let message =
                    'Gagal mengambil data Keluhan Utama.';
    ...
    function simpanPemeriksaanFisik() {
        ...
        $.ajax({
            url: `/api/v2/emr/pengkajian/rajal/keluhan_utama/${kunjungan}/simpan`,
            type: 'POST',
            data: data,
            ...
            error: function (xhr) {
                ...
                let message =
                    'Data Keluhan Utama gagal disimpan.';
