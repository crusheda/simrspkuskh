...
(function () {
    ...
    function getAnamnesisRI() {
        ...
        $.ajax({
            url: `/api/v2/emr/pengkajian/ri/anamnesis/${kunjungan}`,
            type: 'GET',
            dataType: 'json',
            ...
            success: function (res) {
                ...
                if (
                    anam3 &&
                    FormHelper.hasValue(anam3.DESKRIPSI)
                ) {
                    FormHelper.setValue(
                        $section,
                        'rps',
    ...
    function simpanAnamnesisRI() {
        ...
        $.ajax({
            url: `/api/v2/emr/pengkajian/ri/anamnesis/${kunjungan}/simpan`,
            type: 'POST',
            data: data,
    ...
    $(function () {
        ...
        // ANAMNESIS DIPEROLEH
        $section
            .off('change.anam1', `${formSelector} input[name="anam1"]`)
            .on('change.anam1', `${formSelector} input[name="anam1"]`, function () {
        ...
        $section
            .off('change.anam2', `${formSelector} input[name="anam2"]`)
            .on('change.anam2', `${formSelector} input[name="anam2"]`, function () {
                if (isAnamnesisRILoading) {
                    return;
                }
