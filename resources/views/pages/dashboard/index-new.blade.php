...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('v2/images/apple-touch-icon.png') }}">
            ...
            <div class="app-header-inner">
                ...
                <div class="app-header-start d-none d-md-flex">
                    <form class="d-flex align-items-center h-100 w-lg-250px w-xxl-300px position-relative"
                        ...
                        <input type="text" class="form-control form-control-fill ps-5"
                            placeholder="Search anything's" data-bs-toggle="modal"
                ...
                <div class="app-header-end">
                    <div class="px-lg-4 px-2 ps-0 d-flex align-items-center">
                        <a href="javascript:void(0);" class="theme-btn">
                            <svg class="icon-light" width="20" height="21" viewBox="0 0 20 21"
                    ...
                    <div class="d-flex align-items-center gap-sm-2 gap-0 px-lg-4 px-sm-2 px-1">
                        <a href="email/inbox.html"
                            ...
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                ...
                                <path d="M7 14.5H16" stroke="var(--bs-heading-color)" stroke-width="2"
                                    stroke-linecap="round" />
                                <path d="M7 18H13" stroke="var(--bs-heading-color)" stroke-width="2"
                                    stroke-linecap="round" />
                            </svg>
                            <span
                            ...
                            <button type="button"
                                ...
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                    ...
                                    <path opacity="0.5"
                                        ...
                                        stroke="var(--bs-heading-color)" stroke-width="2" stroke-linecap="round" />
                                    <path opacity="0.5" d="M12 6.5V10.5" stroke="var(--bs-heading-color)"
                            ...
                            <div class="dropdown-menu dropdown-menu-lg-end p-0 w-300px mt-2">
                                ...
                                <div class="p-2" style="height: 300px;" data-simplebar>
                                    <ul class="list-group list-group-hover list-group-smooth list-group-unlined">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <div class="avatar avatar-xs avatar-status-success rounded-circle me-1">
                                                <img src="{{ asset('v2/images/avatar/avatar3.webp') }}" alt="">
                                            </div>
                                            <div class="ms-2 me-auto">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <div class="avatar avatar-xs avatar-status-danger rounded-circle me-1">
                                                <img src="{{ asset('v2/images/avatar/avatar5.webp') }}" alt="">
                                            </div>
                                            <div class="ms-2 me-auto">
                        ...
                        <a href="calendar.html"
                            ...
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="var(--bs-heading-color)" stroke-width="2" />
                                <path opacity="0.5" d="M7 4.5V3" stroke="var(--bs-heading-color)" stroke-width="2"
                                    stroke-linecap="round" />
                                <path opacity="0.5" d="M17 4.5V3" stroke="var(--bs-heading-color)" stroke-width="2"
                                    stroke-linecap="round" />
                                <path opacity="0.5" d="M2.5 9.5H21.5" stroke="var(--bs-heading-color)"
                                    stroke-width="2" stroke-linecap="round" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="var(--bs-heading-color)" />
                                <path
                                    d="M13 13.5C13 14.0523 12.5523 14.5 12 14.5C11.4477 14.5 11 14.0523 11 13.5C11 12.9477 11.4477 12.5 12 12.5C12.5523 12.5 13 12.9477 13 13.5Z"
                                    fill="var(--bs-heading-color)" />
                                <path
        ...
        <aside class="app-menubar-tabs" id="appMenubar">
            <div class="app-navbar-brand">
                <a class="navbar-brand-logo" href="index.html">
                    <img src="{{ asset('v2/images/logo.svg') }}" alt="NexLink Admin Dashboard Logo">
                </a>
            </div>
            <div class="app-navbar-tabs" data-simplebar>
                <ul class="nav" id="appMenubarTabs" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="menu-link active" href="#dashboardTab" role="tab" aria-controls="dashboardTab"
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path opacity="0.5"
                                    ...
                                    stroke="var(--bs-heading-color)" stroke-width="2" />
                                <path d="M12 15V18" stroke="var(--bs-heading-color)" stroke-width="2"
                                    stroke-linecap="round" />
                            </svg>
                        </a>
                    </li>
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Apps">
                        <a class="menu-link" href="#appsTab" role="tab" aria-controls="appsTab"
                    ...
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Pages">
                        <a class="menu-link" href="#pagesTab" role="tab" aria-controls="pagesTab"
                            aria-selected="false" data-bs-toggle="tab">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-bs-title="Authentication">
                        <a class="menu-link" href="#authenticationTab" role="tab"
                            aria-controls="authenticationTab" aria-selected="false" data-bs-toggle="tab">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card overflow-hidden bg-primary border-0 ovarlay-primary-gradient"
                                    ...
                                    <div
                                        ...
                                        <div class="btn-group">
                                            <button
                                                class="btn btn-sm btn-icon text-white waves-effect dropdown-toggle"
                                                type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="fi fi-bs-menu-dots"></i>
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-header d-flex align-items-center justify-content-between border-0 pb-0">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="button"
                                        class="btn btn-sm btn-icon btn-action-primary waves-effect">
                                ...
                                <table id="dt_NewCustomers"
                                        ...
                                        <tr>
                                            <th class="pe-0">
                                                <div class="form-check">
                                                    <input class="form-check-input" data-row-checkbox
                                                        type="checkbox">
                                                </div>
                                            </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="pe-0">
                                                <div class="form-check p-0 w-auto d-inline-block mb-0 mb-n1">
                                                    <input class="form-check-input m-0" data-checkbox=""
                                                        type="checkbox">
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-lg bg-primary-subtle text-primary">Active</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-lg bg-success-subtle text-success">Pending</span>
                                            </td>
                                            <td>
                                                <div class="btn-group float-end">
                                                    <button
                    ...
                    <div class="col-xxl-4">
                        <div class="card">
                            ...
                            <div class="card-body pb-1 px-2 pt-3 overflow-auto" style="height: 385px;"
                                data-simplebar>
                                <ul id="todoList" class="list-group list-group-smooth list-group-unlined todo-nav">
                                    ...
                                    <li
                                        ...
                                        <input class="form-check-input todo-checkbox check-primary" type="checkbox"
                                            checked>
                                    ...
                                    <li
                                        ...
                                        <input class="form-check-input todo-checkbox check-success" type="checkbox"
                                            checked>
                                        <span class="form-label mb-0">Reply to customer emails</span>
                                        <span class="todo-time text-body">04:25PM</span>
                                        <button type="button"
                                    ...
                                    <li
                                        ...
                                        <input class="form-check-input todo-checkbox check-warning" type="checkbox"
                                            checked>
                                        <span class="form-label mb-0">Reply to customer emails</span>
                                        <span class="todo-time text-body">04:25PM</span>
                                        <button type="button"
            ...
            <div class="container-fluid">
                <div class="row g-2">
                    <div class="col-lg-6 col-md-7 text-center text-md-start">
                        <p class="mb-0">© <span class="currentYear">2025</span> NexLink. Proudly powered by <a
...
<!-- Mirrored from nexlink.layoutdrop.com/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jul 2026 03:14:35 GMT -->
