        ...
        <div class="app-header-start d-none d-md-flex">
            <form class="d-flex align-items-center h-100 w-lg-250px w-xxl-300px position-relative"
                ...
                <input type="text" class="form-control form-control-fill ps-5"
                    placeholder="Cari EMR Pasien dengan NORM" data-bs-toggle="modal"
                    data-bs-target="#searchResultsModal" readonly>
            </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header py-2 px-3">
                ...
                <form class="d-flex align-items-center position-relative w-100"
                    ...
                    <button type="button"
                        class="btn btn-sm border-0 position-absolute start-0 p-0">
                        <i class="fi fi-rr-search"></i>
                    </button>
            ...
            <div class="modal-body p-0">
                ...
                {{-- INFO --}}
                <div id="searchInfo"
                    class="px-4 py-3 text-muted small border-bottom">
                    Masukkan No. RM untuk mencari kunjungan pasien.
                </div>
                ...
                <div id="searchEmpty"
                    ...
                    <div class="avatar avatar-lg bg-danger-subtle rounded-circle text-danger mb-3 m-auto">
                    ...
                    <div class="text-muted">
                        Pastikan No. RM yang dimasukkan sudah benar.
                    </div>
