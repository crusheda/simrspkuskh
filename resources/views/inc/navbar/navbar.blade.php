    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                @endcan
                @can('display_antrian_admisi')
                <li class="pc-item {{ request()->routeIs('display.antrian.admisi.index') ? 'active' : '' }}">
                    <a href="{{ route('display.antrian.admisi.index') }}" class="pc-link">
                        <span class="pc-micon">
                            <i class="ph-duotone ph-queue"></i>
                        </span>
                        <span class="pc-mtext" data-i18n="Antrian">Antrian Admisi</span>
                    </a>
                </li>
                @endcan
