...
class PengkajianKhususLanjutanController extends Controller
{
    use FieldEmpty;
    ...
    function index($kunjungan)
    {
        ...
        return view('pages.v2.medicalrecord.detail.form.pengkajian.khusus.lanjutan.index')->with('list',$data);
    }
