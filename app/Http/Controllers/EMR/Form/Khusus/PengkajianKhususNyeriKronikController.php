...
class PengkajianKhususNyeriKronikController extends Controller
{
    use FieldEmpty;
    ...
    function index($kunjungan)
    {
        ...
        return view('pages.v2.medicalrecord.detail.form.pengkajian.khusus.nyerikronik.index')->with('list',$data);
    }
