...
class PengkajianKhususSistemImunTergangguController extends Controller
{
    use FieldEmpty;
    ...
    function index($kunjungan)
    {
        ...
        return view('pages.v2.medicalrecord.detail.form.pengkajian.khusus.sistemimun.index')->with('list',$data);
    }

    function getFormKhusus(Request $request, $KUNJUNGAN)
    {
        $data = DB::table('simrspku_pengkajian.pengkajian_sistem_imun_terganggu')
    ...
    public function simpanFormKhusus(Request $request, $KUNJUNGAN)
    {
        try {
            ...
            */
            ...
            $table = 'simrspku_pengkajian.pengkajian_sistem_imun_terganggu';
