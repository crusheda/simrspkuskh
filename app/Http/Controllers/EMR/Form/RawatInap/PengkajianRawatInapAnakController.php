...
class PengkajianRawatInapAnakController extends Controller
{
    use FieldEmpty;
    ...
    function index($kunjungan)
    {
        ...
        return view('pages.v2.medicalrecord.detail.form.pengkajian.rawat-inap.anak.index')->with('list',$data);
    }
}
